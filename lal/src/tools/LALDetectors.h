...
enum {
	...
	LAL_LIO2_4K_DETECTOR_BIT    	=	LAL_INT8_C(1) << 2 * LAL_LIO2_4K_DETECTOR,
};
...
#define LAL_LIO_4K_DETECTOR_LONGITUDE_RAD        -1.58430937078   /**< LIO_4K vertex longitude (rad; equal to 77°13'25.2") */
#define LAL_LIO_4K_DETECTOR_LATITUDE_RAD         0.53342313506  /**< LIO_4K vertex latitude (rad; equal to 19°44'55") */
#define LAL_LIO_4K_DETECTOR_ELEVATION_SI         -6.574	/**< LIO_4K vertex elevation (m) */
#define LAL_LIO_4K_DETECTOR_ARM_X_AZIMUTH_RAD    1.5707963705062866   /**< LIO_4K x arm azimuth (rad) */
#define LAL_LIO_4K_DETECTOR_ARM_Y_AZIMUTH_RAD    4.40317772346  /**< LIO_4K y arm azimuth (rad) */
#define LAL_LIO_4K_DETECTOR_ARM_X_ALTITUDE_RAD   -0.00031210000   /**< LIO_4K x arm altitude (rad) */
#define LAL_LIO_4K_DETECTOR_ARM_Y_ALTITUDE_RAD   -0.00061070000   /**< LIO_4K y arm altitude (rad) */
#define LAL_LIO_4K_DETECTOR_ARM_X_MIDPOINT_SI    1997.57500000000       /**< LIO_4K x arm midpoint (m) */
#define LAL_LIO_4K_DETECTOR_ARM_Y_MIDPOINT_SI    1997.57500000000        /**< LIO_4K y arm midpoint (m) */
#define LAL_LIO_4K_VERTEX_LOCATION_X_SI          -7.42760447238e+04      /**< LIO_4K x-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO_4K_VERTEX_LOCATION_Y_SI          -5.49628371971e+06       /**< LIO_4K y-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO_4K_VERTEX_LOCATION_Z_SI          3.22425701744e+06      /**< LIO_4K z-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO_4K_ARM_X_DIRECTION_X            -0.95457412153  /**< LIO_4K x-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO_4K_ARM_X_DIRECTION_Y             -0.14158077340   /**< LIO_4K y-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO_4K_ARM_X_DIRECTION_Z            -0.26218911324 /**< LIO_4K z-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO_4K_ARM_Y_DIRECTION_X             0.29774156894  /**< LIO_4K x-component of unit vector pointing along y arm in Earth-centered frame */
#define LAL_LIO_4K_ARM_Y_DIRECTION_Y            -0.48791033647   /**< LIO_4K y-component of unit vector pointing along y arm in Earth-centered frame */
#define LAL_LIO_4K_ARM_Y_DIRECTION_Z             -0.82054461286  /**< LIO_4K z-component of unit vector pointing along y arm in Earth-centered frame */
/*@}*/

/**
 * \name LIGO India 4km Interferometric Detector constants
 * @warning These numbers are subject to change.
 * Same as above just trying with a new name...
 * The following constants describe hypothetical location and geometry
 * of the LIGO India 4km Interferometric Detector that have been used
 * in several studies with LALInference. Note that these data do not
 * represent an actual prospective site.
 */
#define LAL_LIO2_4K_DETECTOR_NAME                 "LIO2_4k" /**< LIO_4K detector name string */
#define LAL_LIO2_4K_DETECTOR_PREFIX               "I2"    /**< LIO_4K detector prefix string */
#define LAL_LIO2_4K_DETECTOR_LONGITUDE_RAD        2.1478   /**< LIO_4K vertex longitude (rad; equal to 77°13'25.2") */
#define LAL_LIO2_4K_DETECTOR_LATITUDE_RAD         0.5447   /**< LIO_4K vertex latitude (rad; equal to 19°44'55") */
#define LAL_LIO2_4K_DETECTOR_ELEVATION_SI         300.0  /**< LIO_4K vertex elevation (m) */
#define LAL_LIO2_4K_DETECTOR_ARM_X_AZIMUTH_RAD    1.5707963705062866   /**< LIO_4K x arm azimuth (rad) */
#define LAL_LIO2_4K_DETECTOR_ARM_Y_AZIMUTH_RAD    0.0   /**< LIO_4K y arm azimuth (rad) */
#define LAL_LIO2_4K_DETECTOR_ARM_X_ALTITUDE_RAD   0.0   /**< LIO_4K x arm altitude (rad) */
#define LAL_LIO2_4K_DETECTOR_ARM_Y_ALTITUDE_RAD   0.0   /**< LIO_4K y arm altitude (rad) */
#define LAL_LIO2_4K_DETECTOR_ARM_X_MIDPOINT_SI    2000.00000000000        /**< LIO_4K x arm midpoint (m) */
#define LAL_LIO2_4K_DETECTOR_ARM_Y_MIDPOINT_SI    2000.00000000000        /**< LIO_4K y arm midpoint (m) */
#define LAL_LIO2_4K_VERTEX_LOCATION_X_SI          1328140.1247480197       /**< LIO_4K x-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO2_4K_VERTEX_LOCATION_Y_SI          5856831.1187494537       /**< LIO_4K y-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO2_4K_VERTEX_LOCATION_Z_SI          2141755.8715670863       /**< LIO_4K z-component of vertex location in Earth-centered frame (m) */
#define LAL_LIO2_4K_ARM_X_DIRECTION_X            -9.72097635269165039e-01  /**< LIO_4K x-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO2_4K_ARM_X_DIRECTION_Y             2.34576612710952759e-01   /**< LIO_4K y-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO2_4K_ARM_X_DIRECTION_Z            -4.23695567519644101e-08 /**< LIO_4K z-component of unit vector pointing along x arm in Earth-centered frame */
#define LAL_LIO2_4K_ARM_Y_DIRECTION_X             -5.76756671071052551e-02  /**< LIO_4K x-component of unit vector pointing along y arm in Earth-centered frame */
#define LAL_LIO2_4K_ARM_Y_DIRECTION_Y            -2.39010959863662720e-01   /**< LIO_4K y-component of unit vector pointing along y arm in Earth-centered frame */
#define LAL_LIO2_4K_ARM_Y_DIRECTION_Z             9.69302475452423096e-01  /**< LIO_4K z-component of unit vector pointing along y arm in Earth-centered frame */
/*@}*/
