...
{
    const double extra_time_fraction = 0.0; /* fraction of waveform duration to add as extra time for tapering */
    const double extra_cycles = 0.0; /* more extra time measured in cycles at the starting frequency */
